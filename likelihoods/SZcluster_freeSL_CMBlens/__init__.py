...
path_to_data = os.path.dirname(os.path.realpath(sys.argv[0])) + '/likelihoods/SZcluster_freeSL_CMBlens'
data = np.loadtxt(path_to_data+'/mean_model_3.dat')
invcov = np.loadtxt(path_to_data+'/icov_model_3.dat')

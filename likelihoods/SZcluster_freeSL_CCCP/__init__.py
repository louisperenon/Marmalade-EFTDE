...
path_to_data = os.path.dirname(os.path.realpath(sys.argv[0])) + '/likelihoods/SZcluster_freeSL_CCCP'
data = np.loadtxt(path_to_data+'/mean_model_2.dat')
invcov = np.loadtxt(path_to_data+'/icov_model_2.dat')
